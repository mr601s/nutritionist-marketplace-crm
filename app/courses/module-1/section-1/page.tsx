export default function Section1Page() {
  return (
    <main className="p-8 max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <div className="relative" style={{ paddingBottom: '56.25%', height: 0 }}>
          <iframe
            ...
            src="https://www.youtube.com/embed/6GGfZHn1rNg"
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold mb-4">⚖️ The Calorie Balance Equation</h2>
        <p className="mb-4">
          Your body has a unique number of calories it needs each day to maintain your current weight. This includes your BMR (the energy you burn at rest) plus everything else—movement, exercise, digestion, etc.
        </p>
        <ul className="list-disc ml-6 mb-4 space-y-2">
          <li>If you consistently eat more than your body needs, it stores the extra.</li>
          <li>If you consistently eat less, your body taps into those stored reserves (fat) for energy.</li>
        </ul>
        <p className="mb-4">
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6 mb-4 space-y-2">
          ...
          <li>Protects your organs, bones, and muscles</li>
