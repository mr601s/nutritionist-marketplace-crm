export default function Section28Page() {
  return (
    <main className="p-8 max-w-4xl mx-auto">
      ...
      <p className="mb-6">
        Meal prepping is one of the most effective ways to stay consistent. It helps you:
      </p>
      ...
      <ul className="list-disc pl-6 mb-6 space-y-2">
        <li>Cook protein and carb sources in bulk (e.g., grilled chicken, lentils, rice, quinoa)</li>
        <li>Keep quick-add items on hand like raw veggies, fruits, nuts, and seeds</li>
        <li>Mix and match throughout the week to keep meals fresh and satisfying</li>
      </ul>
